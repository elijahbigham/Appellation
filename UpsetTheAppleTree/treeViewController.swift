...
class treeViewController: UIViewController {
    ...
    let THINGSTHATHURT : [String] = ["LEGO", "ACID", "HOT SAUCE", "SECOND PLACE", "RAP MUSIC", "CALCULUS", "PHYSICS", "LONELINESS", "BETRAYAL", "SHARK ATTACK", "GUNS", "WORDS", "WRONG ANSWER", "STREAK LOSS", "HOT THINGS", "LOSS", "LOSING THE GAME", "NO WIFI", "DEAD BATTERY"]
    let POKEMON : [String] = ["PIKACHU", "BULBASAUR", "IVYSAUR", "CHARMANDER", "SQUIRTLE", "CHARIZARD", "ARTICUNO", "ARCEUS", "RAYQUAZA", "PIDGEY", "BIDOOF", "EKANS", "NIDORAN", "GHASTLY", "WEEDLE", "JIGGLYPUFF", "ZUBAT", "PSYDUCK", "BELLSPROUT", "GOLEM", "ONIX", "ELECTABUZZ", "MAGIKARP", "GYARADOS", "SNORLAX", "MEWTWO", "FURRET", "RAYQUAZA", "PIPLUP", "LUCARIO"]
