...
class treeViewController: UIViewController {
    ...
    let MEMES : [String] = ["ITS FREE REAL ESTATE", "GRAPE SURGERY", "FORTNITE", "FLEX TAPE", "NIHOYMENYOIMENYOI", "STIMULATE YOUR SENSES", "PEPE THE FROG", "YEET", "DAB", "BOTTOM TEXT", "WWIII", "AREA 51", "KEANU REEVES", "SPONGEBOB", "OK BOOMER", "VIBE CHECK", "BABY YODA", "DEEP FRIED", "BEE MOVIE", "BIG BRAIN", "THANOS", "CRINGE", "FLORIDA MAN", "SHREK", "GARFIELD", "REEEEEEEEEEEEEE"]
